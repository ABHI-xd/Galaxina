...
if ENV:
    ...
    from Galaxina.config import Development as Config
...
pbot = Client("galaxinaPyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from Galaxina.modules.helper_funcs.handlers import (
