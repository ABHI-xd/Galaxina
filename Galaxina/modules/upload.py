...
from Galaxina import telethn as bot
from Galaxina.modules.urluploader import download_file
from Galaxina.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @GalaXinaBot",
            )
        except Exception as e:
            traceback.print_exc()
