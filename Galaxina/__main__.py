...
from Galaxina.modules import ALL_MODULES
from Galaxina.modules.helper_funcs.alternate import typing_action
from Galaxina.modules.helper_funcs.chat_status import is_user_admin
from Galaxina.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="📌ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="https://t.me/Sanki_BOTs"),
        InlineKeyboardButton(text="🖲 ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/Galaxina_Support"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➕ ᴀᴅᴅ ɢᴀʟᴀxɪɴᴀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="t.me/GalaXinaBot?startgroup=true"
        ),
    ],
]


GALAXINA_IMG = "https://telegra.ph/file/b546f497b898df027c62c.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/b546f497b898df027c62c.jpg)
...
Support them  [KuziYo](t.me/KuziYo)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Galaxina.modules." + module_name)
...
def Galaxina_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Sanki Bots.* "
            f"\n\n Join [ GalaXina Updates](https://t.me/Sanki_BOTs) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Galaxina Support](https://t.me/Galaxina_Support).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Galaxina Bot](https://t.me/GalaXinaBot)."
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by Sanki Bots Updates team spending many sleepless nights.. So, Respect it."
            f"\n✪ Some modules in this bot is owned by different authors, So, \n  All credits goes to them \n  Also for <b>Paul Larson for Marie</b>."
            f"\n✪ If you need to ask anything about \n  this bot, Go @{SUPPORT_CHAT}."
            f"\n✪ If you asking nonsense in Support \n  Chat, you will get warned/banned."
            f"\n✪ All api's we used owned by originnal authors \n  Some api's we use Free version \n  Please don't overuse AI Chat."
            f"\n✪ We don't Provide any support to forks,\n  So these terms and conditions not applied to forks \n  If you are using a fork of GalaXina Bot we are not resposible for anything."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Galaxina_about_callback, pattern=r"aboutmanu_"
    )
